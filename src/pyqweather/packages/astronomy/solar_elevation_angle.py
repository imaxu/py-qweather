...
class AstronomySolarElevationAngleResponse(QWeatherResponseBase):
    ...
    updateTime: str
    solarElevationAngle: str
    solarAzimuthAngle: str
    solarHour: str
    hourAngle: str
    ...
    def __init__(self, **kwargs):
        ...
        self.solarElevationAngle = self.get_arg(
            'solarElevationAngle', kwargs, None)
        self.solarAzimuthAngle = self.get_arg(
            'solarAzimuthAngle', kwargs, None)
